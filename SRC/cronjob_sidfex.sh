...
ENV_sidfex=source /home/maren/DEV/Sidfex-NextsimF/SRC/env_sidfex.src

LOGDIR=/home/maren/log
...
# m h dom mon dow  command
05 18 * * * $ENV_sidfex; /home/maren/DEV/Sidfex-NextsimF/SRC/MAIN.sh > $LOGDIR/crontablog_$($DATEVAR).log 2>&1
